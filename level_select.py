...
def n_GetFermiThreeLevelList(proton_num, neutron_num, hkout_path, level_range=10, is_manual_selection=False):
    print(f"\n正在读取文件 {hkout_path}...")
    ...
    n1_level_list = ThreeList2OneList(n_ThreeLevel_list, beta_idx=1)
...
def p_GetFermiThreeLevelList(proton_num, neutron_num, hkout_path, level_range=10, is_manual_selection=False):
    print(f"\n正在读取文件 {hkout_path}...")
    ...
    p1_level_list = ThreeList2OneList(p_ThreeLevel_list, beta_idx=1)
